...
hours_studied = np.array([[2], [3], [4], [5]])  # Hours studied X
exam_scores = np.array([5, 7, 9, 11])  # Exam scores Y
...
if __name__ == "__main__":
    ...
    print(f"Predicted exam score for {hours} hours studied: {predicted_score:.2f}")
